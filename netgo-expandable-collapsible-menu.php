...
Description: NetGo Expandable/Collapsible Menu plugin adds a widget that makes your 'all page list' or 'menu'  with slide animation expandable/collapsible effect.
